...
public class ParkingLotSystemTest {
    ...
    public void givenAVehicle_WhenParked_ShouldReturnTrue() throws ParkingLotException {
        ...
        vehicle = new Vehicle("1", "car", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
    ...
    public void givenAVehicle_WhenNotParked_ShouldReturnFalse() throws ParkingLotException {
        ...
        parkingLotSystem.createParkingLot();
        vehicle = new Vehicle("1", "car", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        Vehicle vehicle1 = new Vehicle("2", "bus", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle);
    ...
    public void givenAVehicles_WhenParkingLotIsFull_ShouldThrowException() {
        try {
            ...
            Vehicle vehicle = new Vehicle("11", "car", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
            parkingLotSystem.park(vehicle);
            Vehicle vehicle1 = new Vehicle("22", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
    ...
    public void givenVehicle_WhenOwnerWantAttendant_ShouldParkTheCar() throws ParkingLotException {
        ...
        vehicle = new Vehicle("1", "car", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle);
        Vehicle vehicle1 = new Vehicle("2", "car1", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle1);
        parkingLotSystem.unPark(vehicle);
        boolean isParked = parkingLotSystem.isVehicleParked(vehicle1);
        Assert.assertEquals(true, isParked);
    ...
    public void givenVehicle_WhenWantToFindCar_ShouldNumberInParkingLot() throws ParkingLotException {
        ...
        Vehicle vehicle2 = new Vehicle("55", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
    ...
    public void givenVehicle_WhenOwnerWantAttendant_ShouldEvenlyDistributeCar() throws ParkingLotException {
        ...
        Vehicle vehicle2 = new Vehicle("55", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle2);
        Vehicle vehicle3 = new Vehicle("75", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
    ...
    public void givenVehicle_WhenHandicapDriverWantAttendant_ShouldGiveNearestFreeSpace() throws ParkingLotException {
        ...
        Vehicle vehicle2 = new Vehicle("55", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle2);
        Vehicle vehicle3 = new Vehicle("75", "Thur", new Driver(Driver.DriverType.HANDICAP), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle3);
        for (int i = 0; i < numberOfCars; i++) {
            Vehicle vehicle = new Vehicle(Integer.toString(i), "BMW", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
            parkingLotSystem.park(vehicle);
    ...
    public void givenVehicle_WhenOwnerWantAttendant_ShouldDirectLargeVehicleToHighestNumberOfFreeSpace() throws ParkingLotException {
        ...
        Vehicle vehicle2 = new Vehicle("55", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
        parkingLotSystem.park(vehicle2);
        Vehicle vehicle3 = new Vehicle("75", "Thur", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.LARGE);
        parkingLotSystem.park(vehicle3);
        for (int i = 0; i < numberOfCars; i++) {
            Vehicle vehicle = new Vehicle(Integer.toString(i), "BMW", new Driver(Driver.DriverType.NORMAL), Vehicle.VehicleType.SMALL);
            parkingLotSystem.park(vehicle);
